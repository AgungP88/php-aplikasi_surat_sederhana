...
?>
<center>
	<h2 class='namaintable' align="left">Edit Surat Masuk</h2>
<table class="tblats">
		<tr>
...
<center>
<form action="smasuk_proses.php?prabowo=edit" method="POST">
		<table class="tblinput" cellpadding="10" cellspacing="0">
			...
			<tr>
				...
				<td align="left"><input type=text name="kirim" value="<?php echo $hasil['tgl_kirim'];?>" required class="date"></td>
			</tr>
			<tr>
				<td align="right" class="asd">Tanggal Terima</td>
				<td align="left"><input type=text name="terima" value="<?php echo $hasil['tgl_terima'];?>" required class="date"></td>
			</tr>
			<tr>
