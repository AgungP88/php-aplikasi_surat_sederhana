...
<center>
	<h2 class='namaintable' align="left">Tambah Disposisi</h2>
<table class="tblats">
		<tr>
...
<center>
<form action="disposisi_proses.php?prabowo=tambah" method="POST">
		<table class="tblinput" cellpadding="10" cellspacing="0">
			...
			<tr>
				...
				<td align="left"><input type=text name='disposisi' required class="inputantbl"></td>
			</tr>
			<tr>
				<td align="right" class="asd">No Agenda</td>
				<td align="left"><input readonly name="agenda" value="<?php echo $hasil['no_agenda'];?>" class="inputantbl"></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td align="left"><input type=text name='kepada' required class="inputantbl"></td>
			</tr>
			<tr>
				<td align="right" class="asd">Keterangan</td>
				<td align="left"><input type=text name='keterangan' required class="inputantbl"></td>
			</tr>
			<tr>
				<td align="right" class="asd">Status Surat</td>
				<td align="left"><input type=text name='status' required class="inputantbl"></td>
			</tr>
			<tr>
				<td align="right" class="asd">Tanggapan</td>
				<td align="left"><input type=text name='tanggapan' required class="inputantbl"></td>
			</tr>
			<tr>
				<td></td>
				<td colspan=2>
